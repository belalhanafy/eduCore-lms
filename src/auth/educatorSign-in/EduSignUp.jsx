...
const { eduSignUp } = assets;

const EduSignUp = () => {
    const { setAllEducators, allEducators } = useContext(AppContext);
    ...
    const handleSubmit = (values, { resetForm }) => {
        ...
        reader.onloadend = () => {
            ...
            setAllEducators([...allEducators, newEducator]);
            resetForm();
            setPreview('');
        ...
        <div className="min-h-screen flex flex-col md:flex-row">
            ...
            <div className="hidden md:block w-1/2 relative">
                ...
                <div className="absolute inset-0 bg-black bg-opacity-50 flex flex-col justify-center items-center px-6 text-center text-white">
                    ...
                    <h2 className="text-3xl font-semibold mb-2">Join EduCore as an Educator</h2>
                    <p className="text-lg max-w-md">
                        Create impactful courses, share your expertise, and shape future minds on our powerful learning platform.
                    </p>
                </div>
            </div>
            ...
            <div className="w-full md:w-1/2 p-8 bg-gray-50 flex items-center justify-center">
                <div className="w-full max-w-md bg-white p-8 rounded-2xl shadow-md">
                    <h2 className="text-2xl font-bold text-center mb-6">Educator Sign Up</h2>
                    <Formik
                        ...
                        {({ setFieldValue }) => (
                            <Form className="flex flex-col gap-4">
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        onChange={(event) => {
                                            ...
                                            if (file) {
                                                const reader = new FileReader();
                                                reader.onload = () => setPreview(reader.result); // ✅ Fixed line
                                ...
                                <div className="text-center text-sm text-gray-600">
                                    ...
                                    <span
                                        onClick={() => navigate('/auth/eduSign-in')}
